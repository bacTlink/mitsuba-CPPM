...
#include <mitsuba/render/cppmphotonmap.h>
...
void CPPMPhotonMap::serialize(Stream *stream, InstanceManager *manager) const {
...
CPPMPhotonMap::~CPPMPhotonMap() {
}

std::string CPPMPhotonMap::toString() const {
    std::ostringstream oss;
    oss << "CPPMPhotonMap[" << endl
...
void CPPMPhotonMap::dumpOBJ(const std::string &filename) {
...
Spectrum CPPMPhotonMap::estimateIrradiance(
...
Spectrum CPPMPhotonMap::estimateRadiance(const Intersection &its,
...
size_t CPPMPhotonMap::estimateRadianceRaw(const Intersection &its,
...
MTS_IMPLEMENT_CLASS_S(CPPMPhotonMap, false, SerializableObject)
MTS_NAMESPACE_END
