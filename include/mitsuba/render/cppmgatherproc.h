...
#pragma once
#if !defined(__MITSUBA_RENDER_CPPMGATHERPROC_H_)
#define __MITSUBA_RENDER_CPPMGATHERPROC_H_
 ...
 * \ingroup librender
 */
class MTS_EXPORT_RENDER CPPMGatherPhotonProcess : public ParticleProcess {
public:
    enum EGatherType {
     ...
     */
    CPPMGatherPhotonProcess(EGatherType type, size_t photonCount,
     ...
     */
    inline CPPMPhotonMap *getPhotonMap() { return m_photonMap; }
...
protected:
    /// Virtual destructor
    virtual ~CPPMGatherPhotonProcess() { }
