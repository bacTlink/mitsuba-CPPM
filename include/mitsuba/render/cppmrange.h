 ...
 * \ingroup librender
 */
class MTS_EXPORT_RENDER CPPMRangeWorkUnit : public WorkUnit {
public:
    inline void set(const WorkUnit *wu) {
        const CPPMRangeWorkUnit *other = static_cast<const CPPMRangeWorkUnit *>(wu);
    ...
    inline std::string toString() const {
        ...
        oss << "CPPMRangeWorkUnit[rangeStart=" << m_rangeStart
            << ", rangeEnd=" << m_rangeEnd << "]";
        return oss.str();
    }
